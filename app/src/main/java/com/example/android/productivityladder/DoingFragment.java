...
public class DoingFragment extends Fragment implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ListView taskListView = (ListView) view.findViewById(R.id.list_doing);
        ...
        taskListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(DoingFragment.this.getActivity(), EditTaskActivity.class);
    ...
    private void insertTask() {
        ...
        values.put(TaskEntry.COLUMN_TASK_STATUS, TaskEntry.STATUS_IN_PROGRESS);
