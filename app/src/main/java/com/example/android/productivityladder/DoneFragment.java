...
public class DoneFragment extends Fragment implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private static final int TASK_LOADER = 3;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ListView taskListView = (ListView) view.findViewById(R.id.list_done);
        ...
        taskListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(DoneFragment.this.getActivity(), EditTaskActivity.class);
    ...
    private void insertTask() {
        ...
        values.put(TaskEntry.COLUMN_TASK_STATUS, TaskEntry.STATUS_COMPLETED);
